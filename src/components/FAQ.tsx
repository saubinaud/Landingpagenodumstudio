export function FAQ() {
  ...
  return (
    <section id="faq" className="py-12 sm:py-16 px-6 relative z-10 bg-white/[0.01]">
      <div className="max-w-3xl mx-auto space-y-4">
        <h2 className="reveal text-center text-2xl font-bold text-white mb-8 uppercase tracking-widest">
